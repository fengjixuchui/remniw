...
define i64 @deref(i64* %p) {
entry:
  %p1 = alloca i64*, align 8
  store i64* %p, i64** %p1, align 8
  %p2 = load i64*, i64** %p1, align 8
  %0 = load i64, i64* %p2, align 8
  ret i64 %0
}

define i64 @doublederef(i64** %p) {
entry:
  %p1 = alloca i64**, align 8
  store i64** %p, i64*** %p1, align 8
  %p2 = load i64**, i64*** %p1, align 8
...
entry:
  ...
  %f2 = alloca i64 (i64)*, align 8
  %f3 = alloca i64 (i64)*, align 8
  %f4 = alloca i64 (i64*)*, align 8
  %f5 = alloca i64 (i64**)*, align 8
